...
public class Test_Case_05 {
	...
	@FindBy(css = "input[id='pan_no']")
	WebElement pan_No;
	
	@FindBy(css = "div[type='button'] svg")
	WebElement error_msg;
	
	public Test_Case_05(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver,this);
	}
	
	public boolean perform_Test_Case_05() {
		...
		pan_No.sendKeys(Common_Utilities.init_prop().get("pan1").toString(),Keys.ENTER);
