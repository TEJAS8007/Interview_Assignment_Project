...
public class Test_Case_06 {
	...
	@FindBy(css = "input[id='point_of_contact.0.email']")
	WebElement email;


	public Test_Case_06(WebDriver driver) {
		this.driver=driver;
		PageFactory.initElements(driver,this);
	}

	@SuppressWarnings("deprecation")
	public String perform_Testcase_06() {
		...
		email.sendKeys(Common_Utilities.init_prop().get("email").toString());
